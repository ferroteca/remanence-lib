...
use crate::device::{AccessMode, Claim, Device, read_exact_at, write_all_at};
use crate::error::{Error, Result};
use crate::geometry::{Geometry, RecordingGeometry};
use crate::media_profile::{AUTHORED, FLEXIBLE_5_25_HARD_10, FLEXIBLE_5_25_SOFT, MediaProfile};
use crate::session::{
...
mod tests {
    ...
    fn claimed_article(claim: &NewMediaClaim) -> &'static MediaProfile {
        crate::media_profile::by_id(claim.article())
