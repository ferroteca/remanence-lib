...
use crate::io::device::{AccessIntent, Capture, Device, MediumDevice, read_exact_at};
...
mod tests {
    use super::*;
    use crate::io::device::write_all_at;
    ...
    fn classify(bytes: &[u8]) -> Result<bool> {
        let file = crate::io::cache::session_storage_file().expect("session storage");
