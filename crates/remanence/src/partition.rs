    ...
    pub fn filesystem_as(self, id: &str) -> Result<StorageSpace<'a>> {
        ...
        match self.backing {
            Backing::Blocks(blocks) => {
                ...
                let catalog = crate::cbm_dos::CbmDosCatalog::open(blocks)?;
            ...
            Backing::Medium(medium) => {
                ...
                let namespace = if id == "fat" {
                    ...
                    let adapter = crate::filesystem_catalog::by_id(id)?;
...
fn fat_namespace(offset: u64, recognition: crate::fat::FatRecognition) -> SpaceNamespace<'static> {
    SpaceNamespace::Fat {
        offset,
