...
pub(crate) struct Presentation {
    ...
    pub(crate) channel_policy: crate::c1541_presentation::ReadChannelPolicy,
    /// The declared bitstream-to-bytestream policy.
    pub(crate) codec_policy: crate::c1541_presentation::GcrCodecPolicy,
    /// The declared bytestream-to-sector reading.
    pub(crate) sector_policy: crate::c1541_sectors::SectorPolicy,
}
...
pub(crate) static C1541: DriveProfile = DriveProfile {
    ...
    presentation: Presentation {
        ...
        // (P29).
        channel_policy: crate::c1541_presentation::ReadChannelPolicy {
            // The zone the family's own density map declares.
            density: crate::c1541_presentation::DensityPolicy::Declared,
            ...
            unzoned: crate::c1541_presentation::UnzonedPolicy::Omit,
            ...
            weak_pulse: crate::c1541_presentation::WeakPulsePolicy::Seeded,
            seed: 0x1541_1541_1541_1541,
        },
        codec_policy: crate::c1541_presentation::GcrCodecPolicy {
            ...
            alignment: crate::c1541_presentation::AlignmentPolicy::Landmark,
            // A pattern the table does not assign keeps its own bits,
            // stated as unresolved and counted.
            unassigned_symbol: crate::c1541_presentation::UnassignedSymbolPolicy::DeclareLoss,
        },
        sector_policy: crate::c1541_sectors::SectorPolicy {
            checksum_failure: crate::c1541_sectors::ChecksumFailurePolicy::DeclareLoss,
            unpaired_record: crate::c1541_sectors::UnpairedRecordPolicy::DeclareLoss,
        },
    },
};
...
pub(crate) struct LocationVerdict {
    ...
    pub artifact: String,
    pub position: crate::kryoflux::StepPosition,
    pub head: Option<u64>,
    ...
    pub duplicate_of: Option<crate::kryoflux::StepPosition>,
    pub claimed: bool,
...
fn step_position(key: &TrackKey) -> crate::kryoflux::StepPosition {
    let (numerator, denominator) = key.position().parts();
    crate::kryoflux::StepPosition {
        numerator,
        denominator,
    }
}
...
mod fixture_tests {
    ...
    fn probed() -> &'static Probed {
        ...
        PROBED.get_or_init(|| {
            ...
            let capture = crate::remanence_reconstruction::fixture_capture(&capture_path);
