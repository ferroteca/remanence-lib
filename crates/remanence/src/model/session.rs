...
use crate::io::source::{ArchiveLayer, Evidence};
...
mod tests {
    ...
    fn session_loads_file_and_identifies_the_image_layer() {
        ...
        let disk =
            crate::model::disk::MediaState::open(&path, AccessIntent::Read).expect("disk opens");
    ...
    fn a_declared_cache_bound_streams_identification() {
        ...
        let disk = crate::model::disk::MediaState::open_with_cache(&path, AccessIntent::Read, 1)
            .expect("disk opens");
        let identification = disk.identify();
    ...
    fn sequential_reads_stream_correctly_beside_the_prefetcher() {
        ...
        let disk = crate::model::disk::MediaState::open_with_cache(
            &path,
            AccessIntent::Read,
            4 * 64 * 1024,
        )
