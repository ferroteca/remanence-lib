...
use crate::flux::capture::{SessionBacking, TimeBase};
...
mod tests {
    use super::*;
    use crate::flux::medium::MediumFact;
    ...
    impl crate::flux::capture::ByteSource for VecSource {
    ...
    fn decode_at(path: &Path, cache_bytes: u64) -> Result<(FluxMedium, P64Report)> {
        let source = crate::io::source::claim_image(path, crate::io::device::AccessIntent::Read)?
            .resolve(cache_bytes);
