...
//! [`crate::flux::capture::FluxCapture`] holds several observations of a
...
mod tests {
    ...
    fn media() -> &'static crate::model::media_profile::MediaProfile {
        &crate::model::media_profile::FLEXIBLE_5_25_SOFT
    }
