...
This is not the Windows case. Windows persists its own mapping and the
library reads it (U13, U16); DOS persists nothing, so the mapping is a
*rule* applied to machine facts, and the rule is what has to be named. The
