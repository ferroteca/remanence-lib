...
/// The fixtures live beside this crate rather than inside it: they are
/// read by this suite, by the C/C++ CTest suite over in
/// `crates/remanence-ffi/c/tests/`, and by the prep script that writes
/// them, so belonging to any one of those three would be a claim none
/// of the others can honour.
